# Coursera - Algorithm Specialization Course Part-1(Stanford University)

This repo holds my solutions (in Python 3) to the programming assignments for the [Coursera class - Algorithms Specialization by Stanford University.](https://www.coursera.org/learn/algorithms-divide-conquer/)

 ### Algorithms:
 
  * [QuickSort](https://github.com/rjayswal-pythonista/Algorithms/tree/master/QuickSort)
  * [MergeSort](https://github.com/rjayswal-pythonista/Algorithms/blob/master/MergeSort_Algorithm.py)

#### Course Assignments-Part 1:
